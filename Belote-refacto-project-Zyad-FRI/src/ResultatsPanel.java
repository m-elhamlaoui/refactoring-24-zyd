...
public class ResultatsPanel extends JPanel {
    ...
    private void createResultsTable() {
        ...
        table.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(
                ...
                // If this is the top row and there's data, highlight it as the winner
    ...
    public void refreshData() {
        ...
        for (EquipeResult r : results) {
            // Update to show actual calculated values
            tableModel.addRow(new Object[]{
                r.equipeNum,
                r.player1,
                r.player2,
                r.score,  // This will now show the actual score
                r.wins,   // This will show actual wins
                r.played  // This will show actual played matches
            });
        }

        // Update winner display
        String topTeam = controller.getWinner();
        if (topTeam != null && !topTeam.isEmpty()) {
